 ...
 * pick up mid-stream without a cached header, unlike formats (e.g.
 * fragmented MP4) that need an init segment every subscriber must receive
 * first before anything decodes.
 */
